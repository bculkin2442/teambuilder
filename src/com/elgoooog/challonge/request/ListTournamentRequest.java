...
/**
 * @author Nicholas Hauschild Date: 5/11/13 Time: 11:31 PM
 */
public class ListTournamentRequest {
	...
	public ListTournamentRequest(final TournamentState state,
			final TournamentType type, final Date createdAfter,
			final Date createdBefore, final String subdomain) {
		this.state = state;
		this.type = type;
	...
	public static class Builder {
		...
		public ListTournamentRequest build() {
			return new ListTournamentRequest(state, type, createdAfter,
					createdBefore, subdomain);
		}
	}
}

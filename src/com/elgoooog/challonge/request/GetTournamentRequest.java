...
/**
 * @author Nicholas Hauschild Date: 5/14/13 Time: 12:58 AM
 */
public class GetTournamentRequest {
	...
	public GetTournamentRequest(String urlPath,
	...
	public static class Builder {
		...
		public GetTournamentRequest build() {
			return new GetTournamentRequest(urlPath, includeParticipants,
					includeMatches);
		}
	}
}

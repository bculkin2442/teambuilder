...
/**
 * @author Nicholas Hauschild Date: 5/16/13 Time: 11:36 PM
 */
public class ListMatchRequest {
	...
	public ListMatchRequest(final String tournamentUrlPath,
			final String state, final Integer participantId) {
	...
	public static class Builder {
		...
		public ListMatchRequest build() {
			return new ListMatchRequest(tournamentUrlPath, state,
					participantId);
		}
	}
}

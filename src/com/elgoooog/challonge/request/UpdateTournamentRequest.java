...
/**
 * @author Nicholas Hauschild Date: 5/15/13 Time: 1:02 AM
 */
public class UpdateTournamentRequest {
	...
	public UpdateTournamentRequest(String originalUrlPath, String name,
			TournamentType type, String urlPath, String subdomain,
			String description, Boolean openSignup,
			Boolean holdThirdPlaceMatch, Double pointsForMatchWin,
			Double pointsForMatchTie, Double pointsForGameWin,
			Double pointsForGameTie, Double pointsForBye,
			Integer swissRounds, String rankedBy,
	...
	public static class Builder {
		...
		public UpdateTournamentRequest build() {
			return new UpdateTournamentRequest(originalUrlPath, name, type,
					urlPath, subdomain, description, openSignup,

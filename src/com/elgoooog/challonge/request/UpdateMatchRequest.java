...
/**
 * @author Nicholas Hauschild Date: 5/17/13 Time: 12:03 AM
 */
public class UpdateMatchRequest {
	...
	public UpdateMatchRequest(final String tournamentUrlPath,
			final int matchId, final List<MatchScore> matchScores,
			final Integer winnerId, final Boolean tie,
			final Integer playerOneVotes, final Integer playerTwoVotes) {
	...
	public static class Builder {
		...
		public Builder withMatchScores(
		...
		public UpdateMatchRequest build() {
			return new UpdateMatchRequest(tournamentUrlPath, matchId,
					matchScores, winnerId, tie, playerOneVotes,
					playerTwoVotes);
		}
	}
}

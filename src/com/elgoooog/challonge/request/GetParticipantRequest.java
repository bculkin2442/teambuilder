...
/**
 * @author Nicholas Hauschild Date: 5/15/13 Time: 11:54 PM
 */
public class GetParticipantRequest {
	...
	public GetParticipantRequest(final String tournamentUrlPath,
			final int participantId, final Boolean includeMatches) {
	...
	public static class Builder {
		...
		public GetParticipantRequest build() {
			return new GetParticipantRequest(tournamentUrlPath,
					participantId, includeMatches);
		}
	}
}

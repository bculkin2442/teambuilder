...
/**
 * @author Nicholas Hauschild Date: 5/15/13 Time: 11:09 PM
 */
public class CreateParticipantRequest {
	...
	public CreateParticipantRequest(final String tournamentUrlPath,
			final String name, final String challongeUsername,
	...
	public static class Builder {
		...
		public CreateParticipantRequest build() {
			return new CreateParticipantRequest(tournamentUrlPath, name,
					challongeUsername, email, seed, misc);
		}
	}
}

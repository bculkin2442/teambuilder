...
/**
 * @author Nicholas Hauschild Date: 5/15/13 Time: 10:29 PM
 */
public class StartTournamentRequest {
	...
	public StartTournamentRequest(final String urlPath,
			final Boolean includeParticipants,
	...
	public static class Builder {
		...
		public Builder doIncludeParticipants(
				final Boolean includeParticipants) {
			this.includeParticipants = includeParticipants;
			return this;
		}
		...
		public StartTournamentRequest build() {
			return new StartTournamentRequest(urlPath, includeParticipants,
					includeMatches);
		}
	}
}

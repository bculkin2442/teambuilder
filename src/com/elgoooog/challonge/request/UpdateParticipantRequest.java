...
/**
 * @author Nicholas Hauschild Date: 5/16/13 Time: 10:46 PM
 */
public class UpdateParticipantRequest {
	...
	public UpdateParticipantRequest(final String tournamentUrlPath,
			final int participantId, final String name, final Integer seed,
			final String challongeUsername, final String email,
			final String misc) {
	...
	public static class Builder {
		...
		public UpdateParticipantRequest build() {
			return new UpdateParticipantRequest(tournamentUrlPath,
					participantId, name, seed, challongeUsername, email,
					misc);
		}
	}
}

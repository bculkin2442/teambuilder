...
/**
 * @author Nicholas Hauschild Date: 5/13/13 Time: 8:53 PM
 */
public class CreateTournamentRequest {
	...
	public CreateTournamentRequest(String name, TournamentType type,
			String urlPath, String subdomain, String description,
			Boolean openSignup, Boolean holdThirdPlaceMatch,
			Double pointsForMatchWin, Double pointsForMatchTie,
			Double pointsForGameWin, Double pointsForGameTie,
			Double pointsForBye, Integer swissRounds, String rankedBy,
			Double rrPointsForMatchWin, Double rrPointsForMatchTie,
			Double rrPointsForGameWin, Double rrPointsForGameTie,
			Boolean acceptAttachments, Boolean hideForum,
			Boolean showRounds, Boolean privat,
			Boolean notifyUsersWhenMatchesOpen,
			Boolean notifyUsersWhenTheTournamentEnds,
			Boolean sequentialPairings, Integer signupCap) {
		this.name = name;
		this.type = type;
	...
	public static class Builder {
		...
		public Builder setHoldThirdPlaceMatch(
				Boolean holdThirdPlaceMatch) {
			this.holdThirdPlaceMatch = holdThirdPlaceMatch;
			return this;
		}
		...
		public Builder withRrPointsForMatchWin(
				Double rrPointsForMatchWin) {
			this.rrPointsForMatchWin = rrPointsForMatchWin;
			return this;
		}

		public Builder withRrPointsForMatchTie(
				Double rrPointsForMatchTie) {
			this.rrPointsForMatchTie = rrPointsForMatchTie;
			return this;
		}
		...
		public CreateTournamentRequest build() {
			return new CreateTournamentRequest(name, type, urlPath,
					subdomain, description, openSignup,
					holdThirdPlaceMatch, pointsForMatchWin,
					pointsForMatchTie, pointsForGameWin, pointsForGameTie,
					pointsForBye, swissRounds, rankedBy,
					rrPointsForMatchWin, rrPointsForMatchTie,
					rrPointsForGameWin, rrPointsForGameTie,
					acceptAttachments, hideForum, showRounds, privat,
					notifyUsersWhenMatchesOpen,
					notifyUsersWhenTheTournamentEnds, sequentialPairings,
					signupCap);
		}
	}
}

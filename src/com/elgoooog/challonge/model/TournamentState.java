...
/**
 * @author Nicholas Hauschild Date: 5/11/13 Time: 11:33 PM
 */
public enum TournamentState {
	ALL("all"), PENDING("pending"), IN_PROGRESS("in_progress"), UNDERWAY(
			"underway"), AWAITING_REVIEW(
					"awaiting_review"), ENDED("ended");

...
/**
 * @author Nicholas Hauschild Date: 5/11/13 Time: 11:30 PM
 */
public class Tournament {
	...
	public Tournament(final boolean acceptAttachments,
			final boolean anonymousVoting, final String category,
			final Date checkInAt, final Date completedAt,
			final Date createdAt, final boolean createdByApi,
			final boolean creditCapped, final String description,
			final boolean enableGroupStage, final int gameId,
			final boolean hideForum, final boolean hideSeeds,
			final boolean holdThirdPlaceMatch, final int id,
			final int maxPredictionsPerUser, final String name,
			final boolean notifyUsersWhenMatchesOpen,
			final boolean notifyUsersWhenTheTournamentEnds,
			final boolean openSignup,
			final int participantCountToAdvancePerGroup,
			final int participantsCount, final int predictionMethod,
			final Date predictionsOpenedAt, final boolean privat,
			final int progressMeter, final double pointsForBye,
			final double pointsForGameTie, final double pointsForGameWin,
			final double pointsForMatchTie, final double pointsForMatchWin,
			final String rankedBy, final boolean requireScoreAgreement,
			final String roundLabels, final double rrPointsForGameTie,
			final double rrPointsForGameWin,
			final double rrPointsForMatchTie,
			final double rrPointsForMatchWin, final int secondPlaceId,
			final boolean sequentialPairings, final boolean showRounds,
			final int signupCap, final boolean signupRequiresAccount,
			final Date startedAt, final TournamentState state,
			final int swissRounds, final int thirdPlaceId,
			final TournamentType tournamentType, final Date updatedAt,
			final String url, final int winnerId,
			final String descriptionSource, final String subdomain,
			final String fullChallongeUrl, final String liveImageUrl,
			final String signUpUrl, final boolean reviewBeforeFinalizing,
	...
	public static class Builder {
		...
		public Builder doAcceptAttchments(
				final boolean acceptAttachments) {
			this.acceptAttachments = acceptAttachments;
			return this;
		}
		...
		public Builder doHoldThirdPlaceMatch(
				final boolean holdThirdPlaceMatch) {
			this.holdThirdPlaceMatch = holdThirdPlaceMatch;
			return this;
		}
		...
		public Builder withMaxPredictionsPerUser(
		...
		public Builder doNotifyUsersWhenMatchesOpen(
				final boolean notifyUsersWhenMatchesOpen) {
			this.notifyUsersWhenMatchesOpen = notifyUsersWhenMatchesOpen;
			return this;
		}

		public Builder doNotifyUsersWhenTheTournamentEnds(
				final boolean notifyUsersWhenTheTournamentEnds) {
			this.notifyUsersWhenTheTournamentEnds = notifyUsersWhenTheTournamentEnds;
			return this;
		}
		...
		public Builder withParticipantCountToAdvancePerGroup(
				final int participantCountToAdvancePerGroup) {
			this.participantCountToAdvancePerGroup = participantCountToAdvancePerGroup;
			return this;
		}
		...
		public Builder withPredictionsOpenedAt(
				final Date predictionsOpenedAt) {
			this.predictionsOpenedAt = predictionsOpenedAt;
			return this;
		}
		...
		public Builder withPointsForGameTie(
				final double pointsForGameTie) {
			this.pointsForGameTie = pointsForGameTie;
			return this;
		}

		public Builder withPointsForGameWin(
				final double pointsForGameWin) {
			this.pointsForGameWin = pointsForGameWin;
			return this;
		}

		public Builder withPointsForMatchTie(
				final double pointsForMatchTie) {
			this.pointsForMatchTie = pointsForMatchTie;
			return this;
		}

		public Builder withPointsForMatchWin(
				final double pointsForMatchWin) {
			this.pointsForMatchWin = pointsForMatchWin;
			return this;
		}
		...
		public Builder doRequireScoreAgreement(
				final boolean requireScoreAgreement) {
			this.requireScoreAgreement = requireScoreAgreement;
			return this;
		}
		...
		public Builder withRrPointsForGameTie(
				final double rrPointsForGameTie) {
			this.rrPointsForGameTie = rrPointsForGameTie;
			return this;
		}

		public Builder withRrPointsForGameWin(
				final double rrPointsForGameWin) {
			this.rrPointsForGameWin = rrPointsForGameWin;
			return this;
		}

		public Builder withRrPointsForMatchTie(
				final double rrPointsForMatchTie) {
			this.rrPointsForMatchTie = rrPointsForMatchTie;
			return this;
		}

		public Builder withRrPointsForMatchWin(
				final double rrPointsForMatchWin) {
			this.rrPointsForMatchWin = rrPointsForMatchWin;
			return this;
		}
		...
		public Builder doSequentialPairings(
				final boolean sequentialPairings) {
			this.sequentialPairings = sequentialPairings;
			return this;
		}
		...
		public Builder doSignupRequiresAccount(
				final boolean signupRequiresAccount) {
			this.signupRequiresAccount = signupRequiresAccount;
			return this;
		}
		...
		public Builder withTournamentType(
		...
		public Builder withDescriptionSource(
		...
		public Builder withFullChallongeUrl(
		...
		public Builder doReviewBeforeFinalizing(
				final boolean reviewBeforeFinalizing) {
			this.reviewBeforeFinalizing = reviewBeforeFinalizing;
			return this;
		}

		public Builder withParticipants(
				final List<Participant> participants) {
			this.participants = participants;
			return this;
		}
		...
		public Tournament build() {
			return new Tournament(acceptAttachments, anonymousVoting,
					category, checkInAt, completedAt, createdAt,
					createdByApi, creditCapped, description,
					enableGroupStage, gameId, hideForum, hideSeeds,
					holdThirdPlaceMatch, id, maxPredictionsPerUser, name,
					notifyUsersWhenMatchesOpen,
					notifyUsersWhenTheTournamentEnds, openSignup,
					participantCountToAdvancePerGroup, participantsCount,
					predictionMethod, predictionsOpenedAt, privat,
					progressMeter, pointsForBye, pointsForGameTie,
					pointsForGameWin, pointsForMatchTie, pointsForMatchWin,
					rankedBy, requireScoreAgreement, roundLabels,
					rrPointsForGameTie, rrPointsForGameWin,
					rrPointsForMatchTie, rrPointsForMatchWin,
					secondPlaceId, sequentialPairings, showRounds,
					signupCap, signupRequiresAccount, startedAt, state,
					swissRounds, thirdPlaceId, tournamentType, updatedAt,
					url, winnerId, descriptionSource, subdomain,
					fullChallongeUrl, liveImageUrl, signUpUrl,
					reviewBeforeFinalizing, participants, matches);
		}
	}
}

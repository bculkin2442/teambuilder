...
/**
 * @author Nicholas Hauschild Date: 5/14/13 Time: 8:00 PM
 */
public class Match {
	...
	public Match(final Date createdAt, final int groupId,
			final boolean hasAttachment, final int id,
			final String identifier, final int loserId,
			final int playerOneId,
			final boolean playerOneIsPrereqMatchLoser,
			final int playerOnePrereqMatchId, final int playerOneVotes,
			final int playerTwoId,
			final boolean playerTwoIsPrereqMatchLoser,
			final int playerTwoPrereqMatchId, final int playerTwoVotes,
			final int round, final Date startedAt, final String state,
			final int tournamentId, final Date updatedAt,
			final int winnerId, final List<Integer> prereqMatchIds,
	...
	public static class Builder {
		...
		public Builder doPlayerOneIsPrereqMatchLoser(
				boolean playerOneIsPrereqMatchLoser) {
			this.playerOneIsPrereqMatchLoser = playerOneIsPrereqMatchLoser;
			return this;
		}

		public Builder withPlayerOnePrereqMatchId(
				int playerOnePrereqMatchId) {
			this.playerOnePrereqMatchId = playerOnePrereqMatchId;
			return this;
		}
		...
		public Builder doPlayerTwoIsPrereqMatchLoser(
				boolean playerTwoIsPrereqMatchLoser) {
			this.playerTwoIsPrereqMatchLoser = playerTwoIsPrereqMatchLoser;
			return this;
		}

		public Builder withPlayerTwoPrereqMatchId(
				int playerTwoPrereqMatchId) {
			this.playerTwoPrereqMatchId = playerTwoPrereqMatchId;
			return this;
		}
		...
		public Match build() {
			return new Match(createdAt, groupId, hasAttachment, id,
					identifier, loserId, playerOneId,
					playerOneIsPrereqMatchLoser, playerOnePrereqMatchId,
					playerOneVotes, playerTwoId,
					playerTwoIsPrereqMatchLoser, playerTwoPrereqMatchId,
					playerTwoVotes, round, startedAt, state, tournamentId,
					updatedAt, winnerId, prereqMatchIds, scores);
		}
	}
}

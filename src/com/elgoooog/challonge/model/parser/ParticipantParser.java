...
/**
 * @author Nicholas Hauschild Date: 5/14/13 Time: 8:03 PM
 */
public class ParticipantParser extends Parser<Participant> {
	...
	protected Participant parse(XMLStreamReader xmlReader) {
					...
					case XMLStreamReader.START_ELEMENT:
						...
						if (isNotNil(attrs)) {
							switch (xmlReader.getLocalName()) {
								case "active":
									final boolean active = Boolean.valueOf(
											xmlReader.getElementText());
									builder.doActive(active);
									break;
								case "checked-in":
									final boolean checkedIn = Boolean
											.valueOf(xmlReader
													.getElementText());
								...
								case "created-at":
									...
									break;
								case "final-rank":
									final int finalRank = Integer.valueOf(
											xmlReader.getElementText());
								...
								case "id":
									...
									break;
								case "invitation-id":
									final int invitationId = Integer
											.valueOf(xmlReader
													.getElementText());
									builder.withInvitationId(invitationId);
									break;
								case "invite-email":
									builder.withInviteEmail(
											xmlReader.getElementText());
									break;
								case "misc":
									builder.withMisc(
								...
								case "on-waiting-list":
									final boolean onWaitingList = Boolean
											.valueOf(xmlReader
													.getElementText());
									builder.doOnWaitingList(onWaitingList);
									break;
								case "seed":
									final int seed = Integer.valueOf(
											xmlReader.getElementText());
								...
								case "challonge-username":
									builder.withChallongeUsername(
											xmlReader.getElementText());
									break;
								case "challonge-email-address-verified":
									builder.withChallongeEmailAddressVerified(
											xmlReader.getElementText());
									break;
								case "matches":
		...
		throw new IllegalArgumentException(
				"Couldn't parse Participant from xml");
	}
}

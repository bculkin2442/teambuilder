...
/**
 * @author Nicholas Hauschild Date: 5/14/13 Time: 8:01 PM
 */
public class Participant {
	...
	public Participant(final boolean active, final boolean checkedIn,
			final Date createdAt, final int finalRank, final int groupId,
			final String icon, final int id, final int invitationId,
			final String inviteEmail, final String misc, final String name,
			final boolean onWaitingList, final int seed,
			final int tournamentId, final Date updatedAt,
			final String challongeUsername,
			final String challongeEmailAddressVerified,
	...
	public static class Builder {
		...
		public Builder withChallongeUsername(
				final String challongeUsername) {
			this.challongeUsername = challongeUsername;
			return this;
		}

		public Builder withChallongeEmailAddressVerified(
				final String challongeEmailAddressVerified) {
			this.challongeEmailAddressVerified = challongeEmailAddressVerified;
			return this;
		}
		...
		public Participant build() {
			return new Participant(active, checkedIn, createdAt, finalRank,
					groupId, icon, id, invitationId, inviteEmail, misc,
					name, onWaitingList, seed, tournamentId, updatedAt,
					challongeUsername, challongeEmailAddressVerified,
					matches);
		}
	}
}
